...
| Version | Supported          |
| ------- | ------------------ |
| 0.2.x   | :white_check_mark: (security updates only) |
...
If you find a vulnerability with this package, please report it [here](https://github.com/nuxy/react-tidy-table/issues) for full disclosure.
